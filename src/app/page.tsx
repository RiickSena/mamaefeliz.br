  ...
  return (
    <div className="min-h-screen">
      ...
      <section 
        ...
        style={{
          backgroundImage: 'url(https://k6hrqrxuu8obbfwn.public.blob.vercel-storage.com/temp/fcfc54d4-63c6-49a2-9194-9e636759a9b2.jpg)',
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            {categories.map((category, index) => (
              <Link key={index} href={category.link} onClick={handleLinkClick} className="text-center group">
                <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 hover:bg-white/90 transition-colors shadow-lg">
      ...
      {/* Seção Ofertas */}
      <section id="ofertas" className="py-16 bg-white/80 backdrop-blur-sm">
        <div className="container mx-auto px-4">
          <h3 className="text-3xl font-bold text-center mb-12 text-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {marketplaces.map((marketplace, index) => (
              <div key={index} className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
      ...
      {/* Seção Contato */}
      <section id="contato" className="py-16 bg-gray-900/90 backdrop-blur-sm text-white">
        <div className="container mx-auto px-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-gray-700/80 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500"
                    required
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-3 py-2 bg-gray-700/80 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 resize-none"
      ...
      {/* Rodapé */}
      <footer className="bg-gray-800/90 backdrop-blur-sm text-white py-8">
        <div className="container mx-auto px-4 text-center">
